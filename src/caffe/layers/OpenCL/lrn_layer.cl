template <class T> __kernel void LRNFillScale(const int nthreads, const global float* in, const int num, const int channels, const int height, const int width, const int size, const float alpha_over_size, const float k, global float* scale) {
...
template <class T> __kernel void LRNComputeOutput(const int nthreads, const global float* in, const global float* scale, const float negative_beta, global* out) {
