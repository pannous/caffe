template <class T> __kernel void MaxPoolForward(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h,	const int kernel_w,	const int stride_h,	const int stride_w,	const int pad_h, const int pad_w, global float* top_data, global int* mask, global float* top_mask) {
...
template __attribute__((mangled_name(MaxPoolForwardDouble))) kernel void MaxPoolForward(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, const int pad_h, const int pad_w, global float* top_data, global int* mask, global float* top_mask);

template <class T> __kernel void AvePoolForward(const int nthreads, global float* bottom_data, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h,	const int kernel_w,	const int stride_h,	const int stride_w,	const int pad_h, const int pad_w, global float* top_data) {
...
template __attribute__((mangled_name(AvePoolForwardDouble))) kernel void AvePoolForward(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, const int pad_h, const int pad_w, global float* top_data);
...
template <class T> __kernel void StoPoolForwardTest(const int nthreads, global float* bottom_data, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w,	global float* top_data) {
...
template __attribute__((mangled_name(StoPoolForwardTestDouble))) kernel void StoPoolForwardTest(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, global float* top_data);
...
template <class T> __kernel void AvePoolBackward(const int nthreads, global float* top_diff, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h,	const int kernel_w,	const int stride_h,	const int stride_w,	const int pad_h, const int pad_w, global float* bottom_diff) {
...
template __attribute__((mangled_name(AvePoolBackwardDouble))) kernel void AvePoolBackward(const int nthreads, global float* top_diff, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h,	const int kernel_w,	const int stride_h,	const int stride_w,	const int pad_h, const int pad_w, global float* bottom_diff);

template <class T> __kernel void StoPoolBackward( const int nthreads, global float* rand_idx, global float* top_diff, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, global float* bottom_diff) {
	...
	if ( gidx < nthreads ) {
		...
		for (int ph = phstart; ph < phend; ++ph) {
			for (int pw = pwstart; pw < pwend; ++pw) {
				gradient += top_diff[ph * pooled_width + pw] * (gidx == convert_int((float)rand_idx[ph * pooled_width + pw]));
			}
		}
		bottom_diff[gidx] = gradient;
	}
...
template __attribute__((mangled_name(StoPoolBackwardDouble))) kernel void StoPoolBackward(const int nthreads, global float* rand_idx, global float* top_diff, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, global float* bottom_diff);
