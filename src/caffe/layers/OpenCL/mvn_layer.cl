...
template <class T> __kernel void MVNLayerForwardResidual(global float* bottom_data, const int bottom_data_height, const int bottom_data_width,	global float* sum_multiplier, const int sum_multiplier_width,	global float* mean, const int mean_width,	global float* variance, const int variance_width,	const float eps, global float* top_data, const int top_data_height, const int top_data_width) {
	...
	if ( get_work_dim() == 1 ) {
		...
		T divisor  = (sqrt((float)variance[idx_h] - mean[idx_h]*mean[idx_h]) + eps)*sum_multiplier[idx_w];
...
template <class T> __kernel void MVNLayerForwardMV2(global float* data2D, const int data2D_height, const int data2D_width, global float* data1D, const int data1D_length, global float* linear_term, global float* quadratic_term) {
...
template <class T> __kernel void MVNLayerForward(global float* data2D_in, const int data2D_in_height, const int data2D_in_width, global float* data1D_in, const int data1D_in_length, global float* linear_term, const int linear_term_length, global float* quadratic_term, const int quadratic_term_length, const float eps, global float* data2D_out) {
	...
	T quotient = (sqrt((float)quadratic_term_ptr[0] - linear_term_ptr[0]*linear_term_ptr[0]) + eps)*data1D_in_ptr[0];
...
template <class T> __kernel void MVNLayerForwardS2(global float* data2D_in, const int data2D_in_height, const int data2D_in_width, global float* data1D_in, const int data1D_in_length, global float* data2D_out) {
...
template <class T> __kernel void MVNLayerBackwardMV2(global float* data2D, global float* diff2D, const int data2D_height, const int data2D_width, global float* data1D, const int data1D_length, global float* linear_term, global float* quadratic_term) {
...
template <class T> __kernel void MVNLayerBackward(global float* data2D_in, const int data2D_in_height, const int data2D_in_width, global float* data1D_in, const int data1D_in_length, global float* linear_term, const int linear_term_length, global float* quadratic_term, const int quadratic_term_length, const float eps, global float* data2D_out) {
...
template <class T> __kernel void MVNLayerForward_perf(global float* A2D_top, global float* A2D_top_diff, const int top_height, const int top_width, global float* A2D_bottom, global float* A2D_bottom_diff, const int bottom_height, const int bottom_width, global float* A1D_sum_multiplier, global float* A1D_buffer, const int sum_multiplier_length, const float eps, global float* A2D_out) {
	...
	T quotient = (sqrt((float)sum2 - sum1*sum1) + eps)*_A1D_sum_multiplier[0];
...
template <class T> __kernel void MVNLayerBackward_perf(global float* A2D_top, global float* A2D_top_diff, const int top_height, const int top_width, global float* A2D_bottom, global float* A2D_bottom_diff, const int bottom_height, const int bottom_width, global float* A1D_sum_multiplier, global float* A1D_buffer, const int sum_multiplier_length, const float eps, global float* A2D_out) {
	...
	T divident = S1;
	T quotient = (sqrt((float)sum4 - sum3*sum3) + eps)*A1D_sum_multiplier[idx_w];
