__kernel void MaxPoolForwardFloat(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, const int pad_h, const int pad_w, global float* top_data, global int* mask, global float* top_mask) {
...
__kernel void AvePoolForwardFloat(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, const int pad_h, const int pad_w, global float* top_data) {
...
__kernel void StoPoolForwardTrainFloat(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, global float* rand_idx, global float* top_data) {
...
__kernel void StoPoolForwardTestFloat(const int nthreads, global float* bottom_data, const int num, const int channels, const int height, const int width, const int pooled_height, const int pooled_width, const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, global float* top_data) {
...
__kernel void AvePoolBackwardFloat(const int nthreads, global float* top_diff, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h,	const int kernel_w,	const int stride_h,	const int stride_w,	const int pad_h, const int pad_w, global float* bottom_diff) {
...
__kernel void StoPoolBackwardFloat(const int nthreads, global float* rand_idx, global float* top_diff, const int num, const int channels,	const int height, const int width, const int pooled_height, const int pooled_width,	const int kernel_h, const int kernel_w, const int stride_h, const int stride_w, global float* bottom_diff) {
